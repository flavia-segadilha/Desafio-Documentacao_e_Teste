...
\begin{itemize}
    ...
    \item Manipulação de frames e objetos;
    \item Prototipação;
    \item Comentários;
...
\begin{itemize}
    \item Uso de plugins ou integrações externas;
...
CT2 & Criar um novo frame & Arquivo de design aberto & Frame criado corretamente \\ \hline
CT3 & Prototipar interações & Frame com objetos & Interações aplicadas corretamente \\ \hline
CT4 & Adicionar objeto no frame & Frame criado & Objeto aparece no frame \\ \hline
CT5 & Editar objeto no arquivo & Objeto existente selecionado & Objeto alterado conforme propriedades escolhidas \\ \hline
CT6 & Comentar em algum objeto & Objeto existente selecionado & Comentário visível para todos usuários \\ \hline
CT7 & Desenhar no arquivo & Editor aberto & Desenho aparece corretamente no canvas \\ \hline
CT8 & Compartilhar link para visualização & Arquivo criado & Link ou permissão de visualização funcionando \\ \hline
CT9 & Mover arquivo para uma equipe & Arquivo criado & Arquivo movido para pasta da equipe correta \\ \hline
CT10 & Deletar arquivo & Arquivo criado & Arquivo enviado para lixeira e deletado permanentemente \\ \hline
\end{longtable}
...
\begin{itemize}
    ...
    \item Tela inicial carregada corretamente.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Confirme a criação do frame. \\
\end{enumerate}

\textbf{Resultado esperado} \\
\vspace{0.2cm}
O frame é criado corretamente e aparece no painel de camadas.
...
\begin{itemize}
    ...
    \item Arquivo de design existente;
    \item Arquivo de design aberto;
    \item Ao menos um frame ou objeto existente.
\end{itemize}
